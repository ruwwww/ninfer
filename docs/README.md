...
|---|---|---|---|
| Ornith-1.5-9B | `groupwise-int` | Build locally from the [NVFP4 source checkpoint](https://huggingface.co/ornith-ai/Ornith-1.5-9B-NVFP4) | — |
...
- [Ornith-1.5-9B artifact contract](maintainer/ornith-1.5-9b-artifact.md)
